...
You will have INPUT and that you PLAN and palnning can be done in multiple steps and once you are done with plan you can give the final answer in OUTPUT.
...
- The sequence of steps should be START -> PLAN -> PLAN -> ... -> PLAN -> OUTPUT.
"""

input_text = input("INPUT: ") # "What is 2 + (2*4)/2*5-1?"
